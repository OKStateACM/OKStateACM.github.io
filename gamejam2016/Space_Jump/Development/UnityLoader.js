...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Desktop.data';
    var REMOTE_PACKAGE_BASE = 'Desktop.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 49922477;
      var PACKAGE_UUID = 'bc5bda4f-7be8-4ef5-bd2e-4742a9e7bd0f';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 47571667, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(47571667, 47571688, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(47571688, 47571711, 0, 0).open('GET', '/PlayerConnectionConfigFile');
    new DataRequest(47571711, 47572308, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(47572308, 49019880, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(49019880, 49894852, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(49894852, 49922477, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_Desktop.data');

    };
    Module['addRunDependency']('datafile_Desktop.data');
