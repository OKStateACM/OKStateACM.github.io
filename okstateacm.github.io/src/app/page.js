  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-[32px] row-start-2 items-center">
        <h1 className="text-black text-stroke text-4xl text-center">Association for Computing Machinery<br/>at<br/>Oklahoma State University</h1>
        <Image
          className="" 
          ...
          priority
        />
        <h1 className="text-black text-stroke text-md text-center">Welcome to Oklahoma State University's<br/>Computer Science community!</h1>
